...
impl <S: Strategy> DMC<S> {
    ...
    pub fn branch<R: Rng>(&mut self, rng: &mut R) {
    ...
    pub fn control_population(&mut self) {
        let sign =
    ...
    pub fn stats<W, F>(&self, trial_wavfun: &W, mut update_stats: F)
